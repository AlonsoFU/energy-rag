...
Lee la lista de modelos de argv (ollama/...). Escribe data/eval/results/gen_bakeoff/result.json.
...
OUTDIR = Path("data/eval/results/gen_bakeoff")
...
def main():
    ...
    print("=== FASE A: retrieval 4B-1024+alias, cachea docs ===", flush=True)
    cache = []
    ...
    cfg.settings.embed_4b_dense = False; _stop("ollama/qwen3-embedding:4b")
