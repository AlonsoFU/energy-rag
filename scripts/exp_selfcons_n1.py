"""FASE 1.1 — self_consistency n=3 vs n=1: 3x de velocidad, ¿a qué costo?
...
NAME = os.environ.get("NAME", "selfcons_n1")
...
def main():
    ...
    def arm(qtext, gs, val, q_row=None):
        ...
        # config adoptada SIEMPRE ON; se togglea el numero de generaciones.
    ...
    print(f"=== {NAME}: {len(rows)} pares  OFF(n=1, rapido) / ON(n=3, actual) ===", flush=True)
    nq = 0
