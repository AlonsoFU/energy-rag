...
def test_alias_query_injects_alias_link_doc(monkeypatch):
    ...
    monkeypatch.setattr(ci, "extract_definitional_term", lambda q: "SEC")
    monkeypatch.setattr(
        ci, "find_curated_definition",
...
def test_canonical_query_is_not_treated_as_alias(monkeypatch):
    ...
    monkeypatch.setattr(ci, "extract_definitional_term",
                        lambda q: "Superintendencia de Electricidad y Combustibles")
    monkeypatch.setattr(
        ci, "find_curated_definition",
